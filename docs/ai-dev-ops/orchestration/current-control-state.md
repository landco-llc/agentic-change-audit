...
| ACA-W004 continuous orchestration integration | `IMPLEMENTING` | Authorized bounded local integration is in progress; no pull request, audit PASS, Ready, or merge evidence is recorded. |
