...
| ACA-W003 history reconciliation | `POST_MERGE_SYNC` | Public-safe ACA-W002 history is recorded in `history/ACA-W002.md`; a separate docs-only audit is the next action. |
