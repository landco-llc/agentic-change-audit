...
Local marketplaceでのテスト、ChatGPT desktopへのinstall、呼び出し例については[Codex Plugin README](https://github.com/landco-llc/agentic-change-audit/tree/main/plugins/agentic-change-audit)を参照してください。
